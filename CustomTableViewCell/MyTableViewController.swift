...
class MyTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        randomMeAPIService.retrieveAPIData { (result) -> Void in
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let user:User = tableViewData[indexPath.row];
        
        cell.nameLabel.text = user.username;
        cell.numberLabel.text = user.phoneNumber;
        cell.addressLabel.text = user.address;
        cell.myImageView.image = UIImage(data: user.picture!);
